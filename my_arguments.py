...
class Args(object):
    ...
    def set_train_args(self):
        ...
        self.parser.add_argument("--dataset_dir", type=str, default=r"F:\Develop\Python_File\DownLoad\YOLOv1-from-scratch\dataset\cby_yawn_forYolov1")
    ...
    def set_test_args(self):
        ...
        self.parser.add_argument("--use_GPU", action="store_true", help="identify whether to use gpu")
        self.parser.add_argument("--GPU_id", type=int, default=None, help="device id")
        self.parser.add_argument("--dataset_dir", type=str, default=r"F:\Develop\Python_File\DownLoad\YOLOv1-from-scratch\dataset\cby_yawn_forYolov1\img")
        self.parser.add_argument("--weight_path", type=str,
                            default=r"F:\Develop\Python_File\DownLoad\YOLOv1-from-scratch\checkpoints\epoch7.pkl",
